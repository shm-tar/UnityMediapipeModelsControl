...
public class Live2DPref
{
    ...
    public Live2DPref(float ear_max_threshold = 0.385f,
...
public interface Live2DISaveable
{
    void PopulateSaveData(Live2DPref a_SaveData);
    void LoadFromSaveData(Live2DPref a_SaveData);
}
